...
return [
    ...
    */
    ...
    'doesnt_end_with' => 'يجب أن لا ينتهي الحقل :attribute بأحد هذه القيم: :values.',
    'doesnt_start_with' => 'يجب أن لا يبدأ الحقل :attribute بأحد هذه القيم: :values.',
    'email' => 'يجب أن يكون الحقل :attribute عنوان بريد إلكتروني صالح.',
    'ends_with' => 'يجب أن ينتهي الحقل :attribute بأحد هذه القيم: :values.',
    'enum' => 'الحقل :attribute المختار غير صالح.',
    'exists' => 'الحقل :attribute المختار غير صالح.',
    'extensions' => 'يجب أن يحتوي الحقل :attribute على أحد هذه الامتدادات: :values.',
    ...
    'max' => [
        ...
        'string' => 'يجب أن لا يكون عدد أحرف الحقل :attribute أكبر من :max.',
    ],
    ...
    'min' => [
        ...
        'file' => 'يجب أن لا يكون حجم الحقل :attribute أقل من :min كيلوبايت.',
        'numeric' => 'يجب أن لا تكون قيمة الحقل :attribute أقل من :min.',
        'string' => 'يجب أن لا يكون عدد أحرف الحقل :attribute أقل من :min.',
    ],
